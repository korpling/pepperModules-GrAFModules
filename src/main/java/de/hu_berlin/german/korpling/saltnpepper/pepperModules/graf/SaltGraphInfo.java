...
public class SaltGraphInfo {
	...
	public static void printSDocumentGraphInfo(SDocumentGraph docGraph) {
		System.out.println("\tdoc graph name: " + docGraph.getSName() + " id: " + docGraph.getId() + " sid: " + docGraph.getSId());
		System.out.println("\t\troots: " + docGraph.getRoots().size() + " sroots: " + docGraph.getSRoots().size());
		System.out.println("\t\tedges: " + docGraph.getEdges().size() + " nodes : " + docGraph.getNodes().size() + " snodes: " + docGraph.getSNodes().size() + " sfeatures: " + docGraph.getSFeatures().size());
		System.out.println("\t\tlayers: " + docGraph.getLayers().size() + " slayers: " + docGraph.getSLayers().size() + " sannotations: " + docGraph.getSAnnotations().size() + " stokens: " + docGraph.getSTokens().size());
		System.out.println("\t\tsrelations: " + docGraph.getSRelations().size() + " sdomrels: " + docGraph.getSDominanceRelations().size() + " sorderrels: " + docGraph.getSOrderRelations().size() + " sspanningrels: " + docGraph.getSSpanningRelations().size() + " spointingrels: " + docGraph.getSPointingRelations().size() + " stextualres: " + docGraph.getSTextualRelations().size());
	...
	public static void printSDocumentInfo(SDocument doc) {
		System.out.println("\tdocument name: " + doc.getSName() + " id: " + doc.getId());
	}
	...
	public static void printSRelationInfo(SRelation relation) {
		...
		System.out.println("\t\tssource id: " + relation.getSSource().getId() + " starget id: " + relation.getSTarget().getId());
		// relation.getLabels()
		// relation.getLayers()
	...
	public static void printSSpanInfo(SSpan span) {
		...
		System.out.println("\t\tlabels: " + span.getLabels().size() + " sannotations: " + annotations.size() + " sfeatures: " + span.getSFeatures().size() + " slayers: " + span.getSLayers().size());
	...
	public static void printSTokenInfo(SToken token) {
		System.out.println("\t\ttoken name: " + token.getSName() + "token id: " + token.getId());

		System.out.println("\t\tannotations: " + token.getSAnnotations().size() + " labels: " + token.getLabels().size() + " features: " + token.getSFeatures().size() + " layers: " + token.getLayers().size());
		System.out.println("\t\tprimary text: " + SaltReader.getPrimaryTextSequence(token, token.getSDocumentGraph()));
	}

	// public static void main(String[] args) throws FileNotFoundException {
	// String saltProjectPath =
	// Utils.getVariableFromYamlFile("saltProjectPath");
